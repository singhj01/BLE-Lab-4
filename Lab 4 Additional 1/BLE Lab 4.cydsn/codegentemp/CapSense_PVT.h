...
}CapSense_CONFIG_TYPE_POINTERS_P4_v2_10;
...
typedef struct
{
    ...
    CapSense_CONFIG_TYPE_POINTERS_P4_v2_10 const * pointers;
}CapSense_CONFIG_TYPE_P4_v2_10;
...
void TunePrescalers_P4_v2_10(CapSense_CONFIG_TYPE_P4_v2_10 *config);
void TuneSensitivity_P4_v2_10(CapSense_CONFIG_TYPE_P4_v2_10 *config);
void MeasureNoiseEnvelope_P4_v2_10(CapSense_CONFIG_TYPE_P4_v2_10 *config, const uint8 sensorNumber, const uint16 *rawData);
void CalculateThresholds_P4_v2_10(CapSense_CONFIG_TYPE_P4_v2_10 *config, const uint8 sensorNumber, const uint16 *rawData, const uint8 widget, uint8 *fingerThres, uint8 *noiseThres);
void CalibrateSensors_P4_v2_10(CapSense_CONFIG_TYPE_P4_v2_10 *config, uint16 rawLevel);
void CalibrateOneDAC_P4_v2_10(CapSense_CONFIG_TYPE_P4_v2_10 *config, uint16 rawLevel, uint32 curSensor, uint8 *idacLevelsTbl);
